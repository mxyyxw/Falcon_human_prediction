...
def continuous_vector_action_to_hab_dict_v3(
    original_action_space: spaces.Space,
    vector_action_space: spaces.Box,
    action: np.ndarray,
) -> Dict[str, Any]:
    ...
    actual_action_space = original_action_space.spaces.copy()
    if 'agent_0_move_forward' in original_action_space.spaces:
        agent_0_action_list = ['agent_0_stop','agent_0_move_forward','agent_0_turn_left','agent_0_turn_right','agent_0_move_backward','agent_0_discrete_pause']
        agent_0_action_index = int(action[0])
        selected_agent_0_action = agent_0_action_list[agent_0_action_index]
        # 只保留 selected_agent_0_action，删除其余 agent_0 动作
        for key in list(actual_action_space.keys()):
        ...
        agent_0_action_list = ['agent_0_discrete_stop','agent_0_discrete_move_forward','agent_0_discrete_turn_left','agent_0_discrete_turn_right','agent_0_discrete_move_backward','agent_0_discrete_pause']
        agent_0_action_index = int(action[0])
        selected_agent_0_action = agent_0_action_list[agent_0_action_index]
        # 只保留 selected_agent_0_action，删除其余 agent_0 动作
        for key in list(actual_action_space.keys()):
...
class HabGymWrapper(gym.Wrapper):
    ...
    def step(
        ...
        if isinstance(self.action_space, spaces.Box):
            ...
            hab_action = continuous_vector_action_to_hab_dict_v3(
